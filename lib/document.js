...
Document.prototype.set = function (path, val, type, options) {
  ...
  var shouldSet = this.$__try(function(){
    //if this is a reference and the schema of the value matches the expected schema, pre-populate this path
    if(schema.options.ref && (val instanceof Document) && (self.db.model(schema.options.ref).schema === val.schema)){
